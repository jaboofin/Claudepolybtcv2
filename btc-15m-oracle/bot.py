...
class BTCPredictionBot:
    ...
    async def _trading_cycle(self):
        ...
        try:
            ...
            self.trade_logger.log_oracle({"price": consensus.price, "sources": consensus.sources, "spread_pct": consensus.spread_pct})
            ...
            # 3. Strategy
            decision = self.strategy.analyze(candles, consensus.price)
